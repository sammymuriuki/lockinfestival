           ...
           <div class="w3-panel glider-contain">
               ...
               @forelse($podcasts as $podcast)
                   <div class="w3-col l3 m6 s12">
                        ...
                        <a href="{{url('/podcasts/'.$podcast->slug)}}"><img src="{{ asset('images/podcasts/'.$podcast->image) }}" class="artist-pic"></a>
                            <div class="w3-panel">
                            <h3 class="artist-name">{{$podcast->title}}</h3>
                                <p class="artist-synopsis">
                                {{Str::limit($podcast->description, $limit = 200, $end = '...')}}
                                </p> 
                                ...
                                <a href="{{url('/podcasts/'.$podcast->slug)}}" class="w3-btn w3-margin-top  w3-white w3-text-black watch-btn w3-right  w3-margin-right  w3-margin-bottom" style="border-radius: 20px">listen</a>
                            </div>
                        </div>
                   </div>
                @empty
