...
<body>
    ...
    <div class="masterclass w3-animate-left">
           ...
           <div class="w3-panel glider-contain">
               ...
               @forelse($performances as $performance)
                   <div class="w3-col l3 m6 s12">
                        ...
                        <img src="{{ asset('images/masterclasses/'.$performance->image) }}" class="artist-pic">
                            <div class="w3-panel">
                            <h3 class="artist-name">{{$performance->title}} </h3>
                                ...
                                <a href="{{url('/masterclasses/'.$performance->slug)}}" class="w3-btn w3-margin-top  w3-white w3-text-black watch-btn w3-right  w3-margin-right  w3-margin-bottom" style="border-radius: 20px"><i class="fa fa-play"></i> stream</a>
                        </div>
                   </div>
                   </div>
                @empty
