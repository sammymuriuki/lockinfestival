...
<body>
    ...
    <div class="wellness w3-animate-left">
               ...
               @forelse($performances as $performance)
                   <div class="w3-col l3 m6 s12">
                        <div class="artist w3-hover-shadow  w3-margin-bottom">
                          <img src="{{ asset('images/wellness/'.$performance->image) }}" class="artist-pic">
                            <div class="w3-panel">
                            <h3 class="artist-name">{{$performance->title}}</h3>
                                ...
                                <a href="{{url('/wellness/'.$performance->slug)}}" class="w3-btn w3-margin-top  w3-white w3-text-black watch-btn w3-right  w3-margin-right  w3-margin-bottom" style="border-radius: 20px"><i class="fa fa-play"></i> stream</a>
                        </div>
                   </div>
       ...
       <div class="logo-bottom">
        <a href="home.htm"><img src="{{ asset('/images/logo-bottom.png')}}" class="logo2"/></a>
         </div>
     </div>
        </body>
@endsection