...
<body>
    ...
    <div class="vendors  w3-animate-left">
           ...
           <div class="w3-panel glider-contain">
               ...
               @forelse($vendors as $vendor)
                   <div class="w3-col l3 m6 s12">
                        ...
                        <a href="{{url('/vendors/'.$vendor->slug.'/products')}}"><img src="{{ asset('images/vendors/'.$vendor->image) }}" class="artist-pic"></a>
                            <div class="w3-panel">
                            <h3 class="artist-name">{{$vendor->title}}</h3>
                                <p class="artist-synopsis">
                                {{Str::limit($vendor->description, $limit = 200, $end = '...')}}
                                </p> 
                                <a href="{{url('/vendors/'.$vendor->slug.'/products')}}" class="w3-btn w3-margin-top  w3-white w3-text-black watch-btn w3-right  w3-margin-right  w3-margin-bottom" style="border-radius: 20px">View Products</a>
